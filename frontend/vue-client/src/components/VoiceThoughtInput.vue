...
const submitTranscription = async () => {
  ...
  try {
    await voiceThoughtService.createVoiceThought(transcription.value.trim());
    successMessage.value = 'Voice thought saved successfully!';
    transcription.value = '';
    interimText.value = '';
    ...
    console.error('Error saving voice thought:', error);
    errorMessage.value = error.response?.data?.detail || error.message || 'Failed to save voice thought. Please try again.';
  } finally {
